...
export function drawingToDXF(d: Drawing): string {
  ...
  g(9, '$EXTMAX');
  g(10, d.width); g(20, d.height); g(30, 0);
  g(0, 'ENDSEC');
  ...
  g(2, 'LAYER');
  o.push('70', '2');
  for (const [name, color] of [['CUT', 1], ['ENGRAVE', 5]] as const) {
    g(0, 'LAYER');
    g(2, name);
  ...
  for (const pts of d.cuts) {
    ...
    for (let i = 0; i < pts.length; i += 2) {
      g(0, 'VERTEX');
      g(8, 'CUT');
      g(10, pts[i]); g(20, pts[i + 1]); g(30, 0);
    }
    g(0, 'SEQEND');
    g(8, 'CUT');
  }
  for (const c of d.circles) {
    g(0, 'CIRCLE');
    g(8, 'CUT');
    g(10, c.x); g(20, c.y); g(30, 0);
    g(40, c.r);
  }
  for (const t of d.texts) {
    g(0, 'TEXT');
    g(8, 'ENGRAVE');
    g(10, t.x); g(20, t.y); g(30, 0);
    g(40, t.h);
    g(1, t.text);
    o.push('72', '1'); // centre
    g(11, t.x); g(21, t.y); g(31, 0);
    o.push('73', '2'); // middle
  }
  g(0, 'ENDSEC');
  g(0, 'EOF');
